package com.mixedcs.SpringProject.reviews;
...
public class ReviewController {
    ...
    public ResponseEntity<List<Review>> getAllReviews(@PathVariable Long id){
        return new ResponseEntity<>(reviewService.getAllReviews(id),
                HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> addReview(@PathVariable Long companyId,
        ...
        if(isReviewSaved){
            ...
            return new ResponseEntity<>("Review Saved Failed!", HttpStatus.NOT_FOUND);
        }
    }
